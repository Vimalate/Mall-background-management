    ...
    <el-dialog title="修改地址" :visible.sync="addressVisible" width="50%" @close="addressDialogClosed">
      ...
      >
        <el-form-item label="省市区/县" prop="address1">
          <el-cascader :options="cityData" :v-model="addressFrom.address1" expand-trigger="hover"></el-cascader>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    async showProgress() {
      ...
      // 804909574412544580 1106975712662
      if (res.meta.status !== 200) {
        return this.$message.error('查询物流地址失败！')
      }
